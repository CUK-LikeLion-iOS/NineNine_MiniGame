...
struct GameStartingData {
    private let startingResource: [(String, String, UIImage)] = [
        ("탭탭!", "화면에 있는 치즈 버튼을\n10초동안\n마구마구 누르세요!.", #imageLiteral(resourceName: "BBGameCats")),
        ("쉐킷쉐킷!", "휴대폰을 마음껏 흔들어주세요!\n너무 열심히 흔든 나머지\n휴대폰이 날아가지 않도록 주의하세요.", #imageLiteral(resourceName: "BBGameCats")),
        ("부비부비", "화면의 생선을 누른 상태로\n좌우로 마구마구 비벼주세요!\n고양이를 생선으로 재미있게 놀아주세요!", #imageLiteral(resourceName: "BBGameCats")),
